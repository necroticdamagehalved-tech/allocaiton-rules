...
export function initSpecial(){
  ...
  function render(){
    ...
    STATS.forEach(stat => {
      ...
      val.className = 'val';
      val.textContent = String(state.special[stat]);
